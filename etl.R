...
# primeiro, precisamos retirar algumas variaveis diferentes das bases 
# de dados de 2018 e 2019

sinistrosRecife2018Raw <- sinistrosRecife2018Raw[, - c(10, 11, 12)]

names(sinistrosRecife2018Raw)[1] <- "data" # modificando o nome da variavel data
# para ser a mesma que nas bases de dados de 2020 e 2021
...
# tranformando a variavel complemento em fator
sinistrosRecifeRaw$complemento <- as.factor(sinistrosRecifeRaw$complemento)
